...
* Research shows that Introverts tend to report more loneliness (e.g., Saklofske & Yackulic, 1989) but we do not know how it relates to support group size? Is it the same for introverts versus extroverts? How does it relate to structure?
...
* If we want to tackle loneliness, we need to understand it better. First step for developing interventions?
...
* You will conduct your own research in labs. For example, on body image, memory. Some of these will include surveys. But also qualitative research, observations, experiments, etc.

--

* Your very own student project!
